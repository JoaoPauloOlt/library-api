...
public class AuthorController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Invalid author identifier"),
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Invalid author data or identifier"),
            @ApiResponse(responseCode = "404", description = "Author not found"),
            @ApiResponse(responseCode = "409", description = "Author conflicts with existing data"),
            @ApiResponse(responseCode = "401", description = "Authentication required"),
            @ApiResponse(responseCode = "403", description = "Insufficient permission")
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Invalid author identifier"),
            @ApiResponse(responseCode = "404", description = "Author not found"),
            @ApiResponse(responseCode = "409", description = "Author has conflicting dependencies"),
            @ApiResponse(responseCode = "401", description = "Authentication required"),
            @ApiResponse(responseCode = "403", description = "Insufficient permission")
    })
    @DeleteMapping("/{id}")
